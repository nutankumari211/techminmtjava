...
System.setProperty("webdriver.chrome.driver", "C:\\Users\\nutan kumari\\Desktop\\chromedriver-win64\\chromedriver.exe");
...
nameOfGroup(driver,"SamG");
numberOfBranches(driver,"3");
phoneNumber(driver,"8340552001");
selectRole(driver, "Student");
...
driver.get("https://www.teachmint.com/features/certificate-generation");
}
...
public static void navigateToCertificates(WebDriver driver) {
    ...
    WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#fp-ips-banner")));
    ...
    try {
        ...
        element = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#fp-ips-banner")));
        element.click();
    }
}
